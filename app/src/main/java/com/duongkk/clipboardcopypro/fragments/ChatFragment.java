...
import com.duongkk.clipboardcopypro.adapters.MessageAdapter;
...
//        mProgressBar.show();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         View mRootView;   mRootView = inflater.inflate(R.layout.fragmentchat, container, false);
        return mRootView;
    }
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
       // Log.e("Log count ",dataSnapshot.getChildrenCount()+"");
...
//           Message pojo = gson.fromJson(jsonElement, Message.class);
//           mListMessages.add(pojo);
//       }
